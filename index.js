//One thing I have note down imp thing u can put space when putting some name in text field for that thing to resolve u have to make another field surname THANK YOU!!!
...
window.addEventListener('DOMContentLoaded', () => {
     ...
     axios.get("https://crudcrud.com/api/1ef21d7e53ee425a998ecc0e37670bb9/appointment")
       .then((res)  => {
        //console.log(res);
...
function addTransaction(e){
    ...
    axios.post("https://crudcrud.com/api/1ef21d7e53ee425a998ecc0e37670bb9/appointment",details)
       .then((res) => {
...
function showUser(details)
{
    ...
    edbtn.innerHTML=`<p id=${details._id}><button onclick= editUser('${details.text}','${details.amount}','${details._id}')>EDIT</button></p>`
...
function editUser(text,amount,userId)
{
...
function deleteUser(userId)
{
      ...
      // {
        axios.delete(`https://crudcrud.com/api/1ef21d7e53ee425a998ecc0e37670bb9/appointment/${userId}`)
             .then((res) => {
             // console.log(res);
              removeUser(userId)
              // parentEl.removeChild(childEl)
